        ...
        <div className={style.container}>
            ...
            <div className={style.rightComponent}>
                <div className={style.formLogin}>
                    ...
                    <div className={style.btnAvtive}>Login</div>
                    <div className={styleLogin.btnLogin}>
                    ...
                    <div className={style.textLink}>New to G03-Project? <Link to="/g03-react/register"> Register now.</Link></div>
                </div>
            </div>
        </div>
    )
